...
<nav class="navbar navbar-expand-lg bg-light obrazok" >
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto menu">
            <li class="nav-item <?php if(( $url=="http://dbtsp.jecool.net/")) {echo "active";}?>">
                <a class="nav-link domov-tlacidlo" href="http://dbtsp.jecool.net/">Domov <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item <?php if(( $url=="http://dbtsp.jecool.net/propozicie.php")) {echo "active";}?>">
                <a class="nav-link " href="http://dbtsp.jecool.net/propozicie.php" tabindex="-1" aria-disabled="true">Propozície</a>
            </li>
            <li class="nav-item dropdown <?php if(( $url=="http://dbtsp.jecool.net/Vysledky2019.php" || $url=="http://dbtsp.jecool.net/Vysledky2018.php")) {echo "active";}?>">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if(( $url=="http://dbtsp.jecool.net/PovedaliOnas.php")) {echo "active";}?>" href="http://dbtsp.jecool.net/PovedaliOnas.php" tabindex="-1" aria-disabled="true">Povedali o nás</a>
            </li>
